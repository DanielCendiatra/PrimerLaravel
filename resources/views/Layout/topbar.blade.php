          ...
          <div class="dropdown-menu dropdown-user dropdown-menu-end shadow">
            <a class="dropdown-item  gap-2 py-2" href="javascript:;">
              <div class="text-center">
                <img src="{{ URL::asset('build/images/avatars/01.png') }}" class="rounded-circle p-1 shadow mb-3" width="90" height="90" alt="">
                <h5 class="user-name fw-bold" style="word-wrap: break-word; white-space:normal">{{Auth::user()->name}} {{Auth::user()->lastname}}</h5>
              </div>
            </a>
            <hr class="dropdown-divider">
